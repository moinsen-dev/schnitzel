...
# Generated at: 2025-12-04T16:53:26.831227
...
class Post(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(sa.UUID, primary_key=True, nullable=False)
    author_id: Mapped[uuid.UUID] = mapped_column(sa.UUID)
    content: Mapped[str] = mapped_column(sa.Text)
    title: Mapped[str] = mapped_column(sa.String)
    created_at: Mapped[datetime] = mapped_column(sa.DateTime, server_default=func.now())
    author_id: Mapped[uuid.UUID | None] = mapped_column(sa.UUID, sa.ForeignKey("users.id"), nullable=True)
...
class Comment(Base):
    ...
    author_id: Mapped[uuid.UUID] = mapped_column(sa.UUID)
    content: Mapped[str] = mapped_column(sa.Text)
    post_id: Mapped[uuid.UUID] = mapped_column(sa.UUID)
    created_at: Mapped[datetime] = mapped_column(sa.DateTime, server_default=func.now())
    author_id: Mapped[uuid.UUID | None] = mapped_column(sa.UUID, sa.ForeignKey("users.id"), nullable=True)
    post_id: Mapped[uuid.UUID | None] = mapped_column(sa.UUID, sa.ForeignKey("posts.id"), nullable=True)
