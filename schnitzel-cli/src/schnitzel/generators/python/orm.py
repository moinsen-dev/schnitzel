...
"""
    ...
    def _generate_model(self, model: Model) -> str:
        ...
        # Add __table_args__ for composite primary keys
        if is_composite_pk:
        ...
        if model.fields:
            ...
            for field_name, field_def in ordered_fields:
                field_line = self._generate_field_column(field_name, field_def, model.name, is_composite_pk)
    ...
    def _generate_field_column(self, field_name: str, field_def: FieldDefinition, model_name: str = "", is_composite_pk: bool = False) -> str:
